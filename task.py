...
#The variables without the word 'not' were easier to work with, this is because 'not' contradicts the statement, saying the opposite.
# Which were most confusing? Why?
#The most confusing variables were the ones that were a direct statement. Saying exactly what they meant without a contradictary. The statements with 'not' made somebody have to thing and puzzle out the statement.
